...
REQUIRED_PARAMETERS="client_id tenant_id recipient_email scopes group_name shared_calendar_name category_name category_color logging_file_path AM_config PM config days_out update_interval"
